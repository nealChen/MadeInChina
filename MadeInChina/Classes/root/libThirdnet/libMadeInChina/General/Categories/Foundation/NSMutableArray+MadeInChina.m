...
@implementation NSMutableArray (MadeInChina)
...
+ (NSMutableArray *)nonRetainingArray	// copy from Three20
{
	...
	return MIC_AUTORELEASE((__bridge NSMutableArray *)CFArrayCreateMutable( nil, 0, &callbacks ));
}
